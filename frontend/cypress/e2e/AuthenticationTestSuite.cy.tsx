...
describe('Complete test suite that covers basic authentication functionalities', () => {
    ...
    it('should attempt to create account with missing first name', () => {
        ...
        cy.get("[id='email']").type("kien@uottawa.com");
        cy.get("[id='email']").should('have.value', 'kien@uottawa.com');
    ...
    it('should successfully login with valid credentials', () => {
        ...
        cy.get("[type='email']").type('kien@uottawa.com');
        cy.get("[type='email']").should('have.value', 'kien@uottawa.com');
